...
<template>
        ...
        <div class="modal__overlay" tabindex="-1" data-micromodal-close>
            <div class="modal__container w-2/3" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
                        ...
                        <table class="table-auto w-full text-left whitespace-no-wrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">카나</th>
                                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">전화번호</th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                <footer class="modal__footer">
                    <button @click="toggleStatus" type="button" class="modal__btn" data-micromodal-close aria-label="Close this dialog window">닫기</button>
                </footer>
            </div>
        </div>
    </div>
    ...
    <button type="button" @click="searchCustomers" data-micromodal-trigger="modal-1" class="flex mx-auto text-white bg-teal-500 border-0 mt-4 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg">검색</button>
</template>
